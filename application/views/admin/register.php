...
<head> 
  ...
  <title>SISVEN | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="<?php echo base_url();?>auth/index"><b>SISVEN</b></a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>

    <form action="<?php echo base_url();?>auth/addRegistrar" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Retype password" name="repPassword">
